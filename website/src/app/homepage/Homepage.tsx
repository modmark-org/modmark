    ...
    <Container>
      <Hero>
        <div>
          ...
          <About>
            <p>
              ModMark is a modular markup language. It has a lightweight syntax akin to Markdown but
              also offers a lot more flexibility and expressive power. Import packages and use
              modules to add extra functionality in your document or even add support for a new
              output format.
            </p>
            <p>
              ModMark comes bundled with multiple useful packages and can by default output both
              HTML and LaTeX documents. It is still a early protype but you can use it both on the
              web and in your terminal.
            </p>
          </About>
      ...
      <Features>
        <Feature
          ...
          <p>If you have used Markdown before you will quickly feel right at home.</p>
          <p>
            Read the getting started guide to learn more about different ways to{" "}
            <CodeFont>**style** ==text==</CodeFont> and include other elements in your document like
            a <CodeFont>[cite](modmark)</CodeFont> or a{" "}
        ...
        <Feature
          ...
          <p>
            Want to add a citations? Plot a math function? Or render a chess board? There is a
            package for that.
          </p>
        </Feature>
        ...
        <Feature
          ...
          <p>
            The ModMark compiler is free and open source software, learn more on the GitHub page.
            Feel free to report issues or contribute too.
          </p>
        ...
        <Feature
          ...
          <p>
            ModMark packages are <a href="https://webassembly.org/">WebAssembly (WASM)</a> programs
            that use the <a href="https://wasi.dev/">WebAssembly System Interface (WASI)</a>. This
            means that you can develop packages using many different languages.
          </p>
        ...
        <Feature
          ...
          <h1>Learn more</h1>
          <p>
            ModMark was created as a bachelor's thesis project at Chalmers University of Technology
